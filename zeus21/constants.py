...
wavelengthLyA = wavelengthLyC / (1.0 - 1.0 / 4.0)  # lyman alpha, in nm
wavelengthLyB = wavelengthLyC / (1.0 - 1.0 / 9.0)  # lyman beta, in nm
...
ZMAX_Bubbles = 20.0  # where to begin bubbles, since at high z it's very noisy (need dcrit = 1.69 exact)
